...
class UserTest extends DbAbstractTest {
    ...
    @Test
    void addUserToExistingChat() throws IOException, URISyntaxException {
        //when
    ...
    @Test
    void addUserToExistingChatAgain() throws IOException, URISyntaxException {
        //when
        URI uri = getBasicURI().setPath(String.format("/v1/chats/%s/users", defaultChatId)).build();
        HttpPost req = new HttpPost(uri);
        String json = gson.toJson(new CreateUserDto("Vasya Pupkin"));
    ...
    @Test
    void addUserToNotExistingChat() throws IOException, URISyntaxException {
        //when
    ...
    @Test
    void addUserWithoutBodyChat() throws IOException, URISyntaxException {
        //when
        URI uri = getBasicURI().setPath(String.format("/v1/chats/%s/users", defaultChatId)).build();
        HttpPost req = new HttpPost(uri);
        HttpResponse resp = client.execute(req);
